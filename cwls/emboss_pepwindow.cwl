...
inputs:
  ...
  command:
    ...
    default:
      class: File
      location: ../../webservice-clients/python/emboss_pepwindow.py
  ...
  windowsize:
    ...
    doc: "Window size for averaging (smoothing) the hydropathy plot. Use an integer between 1 and 200."
    inputBinding:
      prefix: --windowsize
      position: 9
  ...
  normalize:
    type: string?
    label: Normalize
    doc: "Normalize data values (mean = 0.0, standard deviation = 1.0)"
    inputBinding:
      prefix: --normalize
      position: 10
    default: "false"
