...
inputs:
  ...
  command:
    ...
    default:
      class: File
      location: ../../webservice-clients/python/emboss_pepinfo.py
  ...
  hwindow:
    type: string?
    label: Hydropathy window size
    doc: "This sets the window size for averaging (smoothing) the hydropathy plots. By default a window size of 9 is used, please use an integer between 1 and 200."
    inputBinding:
      prefix: --hwindow
      position: 9
