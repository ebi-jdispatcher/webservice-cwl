...
inputs:
  ...
  command:
    ...
    default:
      class: File
      location: ../../webservice-clients/python/emboss_sixpack.py
  ...
  firstorf:
    type: string?
    label: First ORF
    doc: "Count the beginning of a sequence as a possible ORF, even if it's inferior to the minimal ORF size."
    inputBinding:
      prefix: --firstorf
      position: 10
    default: "true"
  ...
  lastorf:
    type: string?
    label: Last ORF
    doc: "Count the end of a sequence as a possible ORF, even if it's not finishing with a STOP, or inferior to the minimal ORF size."
    inputBinding:
      prefix: --lastorf
      position: 11
    default: "true"
  ...
  reverse:
    type: string?
    label: Reverse
    doc: "Choose this option if you wish to reverse and compliment your sequence."
    inputBinding:
      prefix: --reverse
      position: 12
    default: "true"
  ...
  orfminsize:
    type: string?
    label: ORF minimum size
    doc: "Minimum size of Open Reading Frames (ORFs) to display in the translations."
    inputBinding:
      prefix: --orfminsize
      position: 13
