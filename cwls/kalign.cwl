...
inputs:
  ...
  command:
    ...
    default:
      class: File
      location: ../../webservice-clients/python/kalign.py
  ...
  gapopen:
    ...
    doc: "The penalty for opening/closing a gap. Half the value will be subtracted from the alignment score when opening, and half when closing a gap."
    inputBinding:
      prefix: --gapopen
      position: 11
  ...
  termgap:
    ...
    doc: "Penalty to extend gaps from the N/C terminal of protein or 5'/3' terminal of nucleotide sequences"
    inputBinding:
      prefix: --termgap
      position: 13
  ...
  bonus:
    type: string?
    label: Bonus Score
    doc: "A bonus score that is added to each pair of aligned residues"
    inputBinding:
      prefix: --bonus
      position: 14
