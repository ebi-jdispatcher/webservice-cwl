...
inputs:
  ...
  command:
    ...
    default:
      class: File
      location: ../../webservice-clients/python/emboss_polydot.py
  ...
  gap:
    type: string?
    label: Gap
    doc: "This specifies the size of the gap that is used to separate the individual dotplots in the display. The size is measured in residues, as displayed in the output."
    inputBinding:
      prefix: --gap
      position: 11
