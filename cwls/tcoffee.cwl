...
inputs:
  ...
  command:
    ...
    default:
      class: File
      location: ../../webservice-clients/python/tcoffee.py
  ...
  matrix:
    type: string?
    label: Matrix
    doc: "Matrix series to use when generating the multiple sequence alignment. The program goes through the chosen matrix series, spanning the full range of amino acid distances."
    inputBinding:
      prefix: --matrix
      position: 10
    default: "none"
