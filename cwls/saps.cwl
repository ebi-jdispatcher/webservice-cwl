...
inputs:
  ...
  command:
    ...
    default:
      class: File
      location: ../../webservice-clients/python/saps.py
  ...
  species:
    type: string?
    label: Species
    doc: "Uses the specified species table for quantile comparisons"
    inputBinding:
      prefix: --species
      position: 10
    default: "swp23s"
  ...
  positiveresidues:
    ...
    doc: "By default, SAPS treats only lysine (K) and arginine (R) as positively charged residues.
                Alternatively, Histidine (H) can also be treated as positively charged in all parts of the program
