...
PfamScan (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/pfa/pfamscan_rest>
...
$Id: pfamscan_lwp.pl 2791 2014-05-29 15:31:39Z hpm $
...
[Optional]
  ...
  -D, --database     : str  : Pfam database to search(s). See --paramDetail 
                              database.
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/pfa/pfamscan_rest
