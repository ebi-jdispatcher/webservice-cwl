...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/msa/tcoffee_rest>
...
$Id: tcoffee_lwp.pl 2791 2014-05-29 15:31:39Z hpm $
...
sub load_params {
	...
	if(!$tool_params{'order'} && $params{'outorder'}) {
		$tool_params{'order'} = $params{'outorder'};
	}
