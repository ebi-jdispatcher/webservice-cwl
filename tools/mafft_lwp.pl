...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/msa/mafft_rest>
...
$Id: mafft_lwp.pl 2791 2014-05-29 15:31:39Z hpm $
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/mafft';
...
GetOptions(
    ...
    'treeout=s'     => \$tool_params{'treeout'},	# Guide Tree Output
...
[Optional]
  ...
  -r, --order        : str  : order of sequences in alignment, 
      ...
      --treeout      : str  : Generate guide tree file, Default value is: ON [true]
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/msa/mafft_rest
