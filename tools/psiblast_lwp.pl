...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/sss/psiblast_rest>
...
$Id: psiblast_lwp.pl 2791 2014-05-29 15:31:39Z hpm $
...
GetOptions(
	...
	'psithr|h=f'       => \$tool_params{'psithr'},        # E-value threshold for PSI
	'filter|F=s'       => \$tool_params{'filter'},        # Low complexity filter
	'alignView|m=i'    => \$tool_params{'alignView'},     # Pairwise alignment format
	'scores|v=i'       => \$tool_params{'scores'},        # Number of scores
	'alignments|b=i'   => \$tool_params{'alignments'},    # Number of alignments
	'dropoff|X=i'      => \$tool_params{'dropoff'},       # Dropoff score
	...
	'cpfile|R=s'       => \$params{'cpfile'},             # PSI-BLAST checkpoint
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/sss/psiblast_rest
