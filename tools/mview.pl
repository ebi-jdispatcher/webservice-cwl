...
MView (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/msa/mview_rest>
...
$Id: mview_lwp.pl 2791 2014-05-29 15:31:39Z hpm $
...
GetOptions(
    ...
    'sequence=s'    => \$params{'sequence'},       # Input alignment/SSS result
    'stype=s'       => \$tool_params{'stype'},     # Sequence type
    'informat=s'    => \$tool_params{'informat'},  # Input format
    'outputformat=s' => \$tool_params{'outputformat'}, # Output format
    'htmlmarkup=s'  => \$tool_params{'htmlmarkup'}, # HTML markup type
    'css'           => \$params{'css'},             # Enable CSS
    'nocss'         => \$params{'nocss'},           # Disable CSS
    'pcid=s'        => \$tool_params{'pcid'},       # % identity method
    'alignment'     => \$params{'alignment'},       # Show alignment
    'noalignment'   => \$params{'noalignment'},     # Hide alignment
    'ruler'         => \$params{'ruler'},           # Show ruler
    'noruler'       => \$params{'noruler'},         # Hide ruler
    'width=i'       => \$tool_params{'width'},      # Alignment width
    'coloring=s'    => \$tool_params{'coloring'},   # Style of coloring
    'colormap=s'    => \$tool_params{'colormap'},   # Color map
    'groupmap=s'    => \$tool_params{'groupmap'},   # Group color map
    'consensus'     => \$params{'consensus'},       # Show consensus
    'noconsensus'   => \$params{'noconsensus'},     # Hide consensus
    'concoloring=s' => \$tool_params{'concoloring'}, # Consensus coloring
    'concolormap=s' => \$tool_params{'concolormap'}, # Consensus color map
    'congroupmap=s' => \$tool_params{'congroupmap'}, # Consensus group color map
    'congaps'       => \$params{'congaps'},         # Include gaps in consensus
    'nocongaps'     => \$params{'nocongaps'},       # Exclude gaps in consensus
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/msa/mview_soap
